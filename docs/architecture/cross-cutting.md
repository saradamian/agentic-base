...
| transparency: a person knows they are dealing with an AI, and generated content is marked | the channels block says so on every outbound message | channels; not built |
